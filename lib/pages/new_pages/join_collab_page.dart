...
/// Page affich�e quand l'utilisateur ouvre un lien d'invitation
/// (deep link : doron.app/join/{token}).
/// Si non connect� ✨ redirig� vers le login (g�r� par le routeur).
/// Si connect� ✨ rejoint la collaboration directement.
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          _result = result;
          _isLoading = false;
          if (result == null) _error = 'Lien invalide ou expir�.';
        });
        ...
        if (result != null) {
          ...
          // Naviguer vers le chat de groupe apr�s 1s
          if (chatId != null) {
      ...
      if (mounted) {
        setState(() {
          _error = 'Impossible de rejoindre la liste. R�essaie.';
          _isLoading = false;
        });
      }
    }
          ...
          child: Column(
            ...
            children: [
              ...
              if (_isLoading) ...[
                ...
                Text('Connexion � la collaboration en cours',
                ...
                const SizedBox(height: 16),
                Text(
                  _result?['alreadyMember'] == true ✨ 'Tu es d�j� membre !' : 'Bienvenue !',
