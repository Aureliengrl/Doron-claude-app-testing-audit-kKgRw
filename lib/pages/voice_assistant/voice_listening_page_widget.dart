...
class _VoiceListeningPageWidgetState extends State<VoiceListeningPageWidget> {
  ...
  void initState() {
    ...
    // ✨ IMPORTANT: Ajouter un listener pour forcer le rebuild quand le mod�le change
        ...
        body: SafeArea(
          child: Consumer<VoiceListeningPageModel>(
            builder: (context, model, _) {
              ...
              AppLogger.debug('[VOICE LISTENING BUILD] �tat du mod�le:', 'Debug');
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildSuggestionItem('� Son �ge ou tranche d\'�ge'),
                          _buildSuggestionItem('� Votre budget'),
                          _buildSuggestionItem('� Ses hobbies et centres d\'int�r�t'),
                          _buildSuggestionItem('� L\'occasion (anniversaire, No�l, etc.)'),
