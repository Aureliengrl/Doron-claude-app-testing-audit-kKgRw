...
abstract class FlutterFlowTheme {
  ...
  late Color primaryText800;
  late Color starsColor;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF8A2BE2);
  late Color secondary = const Color(0xFFE2E2E2);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFFC9CECE);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF5A189A);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFF8F8F8);
  late Color accent1 = const Color(0x4DFBEDE7);
  late Color accent2 = const Color(0x4DFE6F6B);
  ...
  late Color primaryText800 = const Color(0xCB14181B);
  late Color starsColor = const Color(0x3314181B);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primaryText800 = const Color(0xCBFFFFFF);
  late Color starsColor = const Color(0x33FFFFFF);
}
